...
import com.furb.mancalajogo.excecoes.*;
...
@DirtiesContext
public class MancalaJogoControllerTests {

    @MockBean
    MancalaService mancalaGameService;
    ...
    public void testSowingTheGameOfInvalidId() throws Exception {
        ...
        Mockito.when(mancalaGameService.loadGame("5d414dcd24e4990006e7c902"))
                .thenThrow(new RecursoNaoEncontradoException("Game id 5d414dcd24e4990006e7c902 not found!"));
